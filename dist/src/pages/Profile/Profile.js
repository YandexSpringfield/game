...
export const Profile = () => {
    ...
    useEffect(() => {
        setFields(Object.assign(Object.assign({}, initialFields), user));
    }, [user]);
    const onChange = (e) => {
    ...
    const onEditProfile = (e) => {
        e.preventDefault();
        const { avatar, oldPassword, newPassword, newPasswordConfirm } = fields, data = __rest(fields, ["avatar", "oldPassword", "newPassword", "newPasswordConfirm"]);
    ...
    const onEditPassword = (e) => {
        ...
        editProfileAPI.editPassword(data).then(() => setFields(Object.assign(Object.assign({}, fields), { oldPassword: '', newPassword: '', newPasswordConfirm: '' })));
    };
    const onLogout = (e) => {
        e.preventDefault();
        authAPI.logout().then(() => {
