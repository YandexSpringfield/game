import { TileConverter } from './TileConverter';
export class TileCollider extends TileConverter {
    checkX(entity) {
        ...
        const matches = this.searchByRange(x, x, entity.pos.y, entity.pos.y + entity.height);
    ...
    checkY(entity) {
        ...
        const matches = this.searchByRange(entity.pos.x, entity.pos.x + entity.width, y, y);
        matches.forEach((match) => {
            if (match.tile.type !== 'ground') {
                return;
            }
