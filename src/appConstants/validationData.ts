...
export const VALIDATION_DATA: TValidation = {
  ...
  login: {
    ...
    message:
      'Допустимо использовать от 3 до 20 символов, только латинские буквы, цифры, "-" и "_"',
  },
  first_name: {
    re: /^[A-ZА-Я][A-Za-zА-Яа-я\\-]+$/,
    message:
      'Допустимо использовать только латиницу или кириллицу, первая буква заглавная',
  },
  second_name: {
    re: /^[A-ZА-Я][A-Za-zА-Яа-я\\-]+$/,
    message:
  ...
  display_name: {
    re: /^[A-Za-zА-Яа-я0-9]+$/,
    message:
      'Допустимо использовать только латиницу или кириллицу, без символов и пробелов',
  },
  password: {
